s = '''|J.7F7-L--77F7-J-F-77FF-7FLLJ7F-J-F---7-J-L-FJ-FJFJ7-7-FF--L7.L--|.FJ-J77FFF|77-7F-7-FFL7-|7-F7-L7F7FF7.|----LL-77FF.F--F-J-LFFL-F-LF7--F-FL
...
while True:
    nextPipe = Pipe(grid,position[0],position[1],currMove)
    position = Move(position[0],position[1],currMove)
    steps += 1
    if position == start:
        print(steps/2)
        break
    currMove = matching[(currMove,nextPipe)]