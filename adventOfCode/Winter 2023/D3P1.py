s = '''.........426.............985.........40..........207............................841..463................................633........17.384...
...
def isAdj(l,r,c):
    if (r != 0 and r!=139) and (c!=0 and c!=139):
        if (not str.isnumeric(l[r-1][c-1]) and l[r-1][c-1] != '.') or (not str.isnumeric(l[r-1][c]) and l[r-1][c] != '.') or (not str.isnumeric(l[r-1][c+1]) and l[r-1][c+1] != '.') or (not str.isnumeric(l[r][c-1]) and l[r][c-1] != '.') or (not str.isnumeric(l[r][c+1]) and l[r][c+1] != '.') or (not str.isnumeric(l[r+1][c-1]) and l[r+1][c-1] != '.') or (not str.isnumeric(l[r+1][c]) and l[r+1][c] != '.') or (not str.isnumeric(l[r+1][c+1]) and l[r+1][c+1] != '.'):
            return True
    elif (r == 0) and (c!=0 and c!=139):
        if (not str.isnumeric(l[r][c-1]) and l[r][c-1] != '.') or (not str.isnumeric(l[r][c+1]) and l[r][c+1] != '.') or (not str.isnumeric(l[r+1][c-1]) and l[r+1][c-1] != '.') or (not str.isnumeric(l[r+1][c]) and l[r+1][c] != '.') or (not str.isnumeric(l[r+1][c+1]) and l[r+1][c+1] != '.'):
            return True
    elif (r == 139) and (c!=0 and c!=139):
        if (not str.isnumeric(l[r-1][c-1]) and l[r-1][c-1] != '.') or (not str.isnumeric(l[r-1][c]) and l[r-1][c] != '.') or (not str.isnumeric(l[r-1][c+1]) and l[r-1][c+1] != '.') or (not str.isnumeric(l[r][c-1]) and l[r][c-1] != '.') or (not str.isnumeric(l[r][c+1]) and l[r][c+1] != '.'):
            return True
    elif (r!=0 and r!=139) and (c == 0):
        if (not str.isnumeric(l[r-1][c]) and l[r-1][c] != '.') or (not str.isnumeric(l[r-1][c+1]) and l[r-1][c+1] != '.') or (not str.isnumeric(l[r][c+1]) and l[r][c+1] != '.') or (not str.isnumeric(l[r+1][c]) and l[r+1][c] != '.') or (not str.isnumeric(l[r+1][c+1]) and l[r+1][c+1] != '.'):
            return True
    elif (r!=0 and r!=139) and (c == 139):
        if (not str.isnumeric(l[r-1][c-1]) and l[r-1][c-1] != '.') or (not str.isnumeric(l[r-1][c]) and l[r-1][c] != '.') or (not str.isnumeric(l[r][c-1]) and l[r][c-1] != '.') or (not str.isnumeric(l[r+1][c-1]) and l[r+1][c-1] != '.') or (not str.isnumeric(l[r+1][c]) and l[r+1][c] != '.'):
            return True
    elif r == 0 and c == 0:
        if (not str.isnumeric(l[r][c+1]) and l[r][c+1] != '.') or (not str.isnumeric(l[r+1][c]) and l[r+1][c] != '.') or (not str.isnumeric(l[r+1][c+1]) and l[r+1][c+1] != '.'):
            return True
    elif r == 0 and c == 139:
        if (not str.isnumeric(l[r][c-1]) and l[r][c-1] != '.') or (not str.isnumeric(l[r+1][c-1]) and l[r+1][c-1] != '.') or (not str.isnumeric(l[r+1][c]) and l[r+1][c] != '.'):
            return True
    elif r == 139 and c == 0:
        if (not str.isnumeric(l[r-1][c]) and l[r-1][c] != '.') or (not str.isnumeric(l[r-1][c+1]) and l[r-1][c+1] != '.') or (not str.isnumeric(l[r][c+1]) and l[r][c+1] != '.'):
            return True
    elif r == 139 and c == 139:
        if (not str.isnumeric(l[r-1][c-1]) and l[r-1][c-1] != '.') or (not str.isnumeric(l[r-1][c]) and l[r-1][c] != '.') or (not str.isnumeric(l[r][c-1]) and l[r][c-1] != '.'):
            return True
    else:
        return False
...
for ind,sen in enumerate(l):
    i = 0
    while i<len(sen):
        if str.isnumeric(sen[i]):
            j = i
            num = ''
            while j < len(sen) and str.isnumeric(sen[j]):
                num = num + sen[j]
                j += 1
            domain.append((ind, i, num))
            i = j
            continue
        i += 1
sum = 0
