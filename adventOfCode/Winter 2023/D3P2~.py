...
def isAdj(l,r,c):
    if (r != 0 and r!=139) and (c!=0 and c!=139):
        if (l[r-1][c-1] == '*') or (l[r-1][c] == '*') or (l[r-1][c+1] == '*') or (l[r][c-1] == '*') or (l[r][c+1] == '*') or (l[r+1][c-1] == '*') or (l[r+1][c] == '*') or (l[r+1][c+1] == '*'):
            return True
    elif (r == 0) and (c!=0 and c!=139):
        if (l[r][c-1] == '*') or (l[r][c+1] == '*') or (l[r+1][c-1] == '*') or (l[r+1][c] == '*') or (l[r+1][c+1] == '*'):
            return True
    elif (r == 139) and (c!=0 and c!=139):
        if (l[r-1][c-1] == '*') or (l[r-1][c] == '*') or (l[r-1][c+1] == '*') or (l[r][c-1] == '*') or (l[r][c+1] == '*'):
            return True
    elif (r!=0 and r!=139) and (c == 0):
        if (l[r-1][c] == '*') or (l[r-1][c+1] == '*') or (l[r][c+1] == '*') or (l[r+1][c] == '*') or (l[r+1][c+1] == '*'):
            return True
    elif (r!=0 and r!=139) and (c == 139):
        if (l[r-1][c-1] == '*') or (l[r-1][c] == '*') or (l[r][c-1] == '*') or (l[r+1][c-1] == '*') or (l[r+1][c] == '*'):
            return True
    elif r == 0 and c == 0:
        if (l[r][c+1] == '*') or (l[r+1][c] == '*') or (l[r+1][c+1] == '*'):
            return True
    elif r == 0 and c == 139:
        if (l[r][c-1] == '*') or (l[r+1][c-1] == '*') or (l[r+1][c] == '*'):
            return True
    elif r == 139 and c == 0:
        if (l[r-1][c] == '*') or (l[r-1][c+1] == '*') or (l[r][c+1] == '*'):
            return True
    elif r == 139 and c == 139:
        if (l[r-1][c-1] == '*') or (l[r-1][c] == '*') or (l[r][c-1] == '*'):
            return True
    else:
        return False
